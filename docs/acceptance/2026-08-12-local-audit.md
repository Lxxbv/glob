...
本记录对应最终验收前的本地修改轮次。历史记录中的“未推送”描述仅适用于 2026-08-12 当时的工作副本；当前版本已经推送到 GitHub、GitLink，并发布到 mooncakes.io `Lxxbv/glob@0.2.6`。
...
- `Lxxbv/glob@0.2.6` 已通过 `moon publish` 发布并完成包内 `moon check` 校验。
