...
moon version --all  # CI uses the current official release; local acceptance passes on moonc v0.10.3
```

Linux/macOS：

```bash
bash -c "\$(curl -fsSL https://cli.moonbitlang.com/install/unix.sh)"
